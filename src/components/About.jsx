    ...
    <div className="flex-about">
        <div className="about-text">
            ...
            I am a recent graduate who obtained a Bacelors of Science in Software Engineering from Arizona State University.
             Arizona State University provided technical exposure to modern Software Engineering methodologies and quality product development.  
            ...
            <p>
            Alongside computer programming, I also enjoy the challenges that aquarium keeping brings.  Having seven different running aquariums, multi-tasking is a key attribute that one must possess to achieve success in this hobby.
            </p>
            </div>
